...
export const metadata = {
  title: "Best Garden Outdoor Furniture Manufacturer in Mumbai",

  description:
    "Artics Decorr – Leading Garden Outdoor Furniture Manufacturer in Mumbai. Explore stylish, durable designs to elevate your outdoor space. Contact us now!",

  keywords: [
    "Garden Outdoor Furniture Manufacturer in Mumbai",
    "Outdoor Furniture Manufacturer in Mumbai",
    "Artics Decorr",
  ],
